...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textViewheaderSlotAppMain = (TextView) findViewById(R.id.textViewheaderSlotAppMain);
        ...
        TextView buttonForgotPassword = (TextView) findViewById(R.id.buttonForgotPassword);
        TextView buttonRegistration = (TextView) findViewById(R.id.buttonRegistration);
        TextView textViewMadeByMeMain = (TextView) findViewById(R.id.textViewMadeByMeMain);
