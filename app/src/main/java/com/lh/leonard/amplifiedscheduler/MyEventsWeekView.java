...
public class MyEventsWeekView extends AppCompatActivity implements
...
// month every time the month changes on the week view.
    ...
    public void onEventClick(WeekViewEvent event, RectF eventRect) {
        ...
        Intent slotDialogIntent = new Intent(MyEventsWeekView.this, MyCreatedSlotsDialog.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_switch:
                startActivity(new Intent(MyEventsWeekView.this, MyCreatedSlots.class));
        }
